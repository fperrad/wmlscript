...
CODE
    wmls_is($S0, <<'OUT', "'ABC' == 'ABC'", 'flags'=>"-On")
true
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'ABC' != '123'", 'flags'=>"-On")
true
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'123' == 123", 'flags'=>"-On")
true
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'123' != 123.4", 'flags'=>"-On")
true
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'123' != true", 'flags'=>"-On")
true
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'text' == invalid", 'flags'=>"-On")
4
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'text' <= 'TEXT'", 'flags'=>"-On")
false
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'text' < 123", 'flags'=>"-On")
false
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'text' >= true", 'flags'=>"-On")
false
3
OUT
.end
...
CODE
    wmls_is($S0, <<'OUT', "'text' > -3.14", 'flags'=>"-On")
true
3
OUT
.end
